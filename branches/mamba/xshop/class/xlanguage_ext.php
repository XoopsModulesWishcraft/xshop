...
class xshopXlanguage_ext extends XoopsObject
{

    function xshopXlanguage_ext($id = null)
    {
...
class xshopXlanguage_extHandler extends XoopsPersistableObjectHandler
{
    function __construct($db) 
    {
		$this->db = $db;
        parent::__construct($db, "xlanguage_ext", 'xshopXlanguage_ext', "lang_id", "lang_name");
    }
