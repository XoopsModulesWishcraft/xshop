...
class xshopExtras extends XoopsObject
{
    function __construct($fields)
    {
		$this->initVar('product_id', XOBJ_DTYPE_INT, null, true);			
 ...
 */
class xshopExtrasHandler extends XoopsPersistableObjectHandler
{
    /**
    ...
    */
    ...
    {
        parent::__construct($db, "shop_extra", 'xshopExtras', "product_id");
        $this->_fHandler = xoops_getmodulehandler('field', 'xshop');
    }

    /**
     * create a new {@link xshopExtras}
     *
     * @param bool $isNew Flag the new objects as "new"?
     *
     * @return object {@link xshopExtras}
     */
    ...
    /**
     * Get a {@link xshopExtras}
     *
     * @param   boolean $createOnFailure create a new {@link xshopExtras} if none is feteched
     *
     * @return  object {@link xshopExtras}
     */
    ...
    */
	...
	{
		return array('product_id', 'topic_id', 'forum_id', 'post_time', 'poster_ip', 'poster_name', 'subject', 'pid', 'dohtml', 'dosmiley', 'doxcode', 'doimage',
