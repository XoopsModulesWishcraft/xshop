...
CREATE TABLE `shop_currency` (
  ...
  `exchange_set` int(13) unsigned DEFAULT '0',
  `md5` varchar(32) DEFAULT NULL,
  `created` int(13) unsigned DEFAULT '0',
  `updated` int(13) unsigned DEFAULT '0',
  PRIMARY KEY (`currency_id`),
  KEY `COMMON` (`currency_id`,`languages`(64),`item_id`,`iso_code`,`default`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

insert  into `shop_currency` (`currency_id`,`languages`,`item_id`,`symbol_left`,`symbol_right`,`decimal_places`,`thousand_seperator`,`iso_code`,`default`,`rate`,`exchange_currency_id`,`exchange_comparison_rate`,`exchange_set`,`md5`,`created`,`updated`) values (1,'a:1:{i:0;s:7:"english";}', 1,'$',NULL,2,',','AUD',1,'1.0000000',0,'1.0000000',0,NULL,0,0);
