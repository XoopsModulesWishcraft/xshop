...
class xshopOrders_connote extends XoopsObject 
{
    function __construct()
    {
        ...
        $this->initVar('assigned_uid', XOBJ_DTYPE_INT, 0, false);
        ...
        $this->initVar('dispatched', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('returned', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('number', XOBJ_DTYPE_TXTBOX, false, false, 128);
