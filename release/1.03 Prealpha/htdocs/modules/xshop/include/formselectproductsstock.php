 ...
 * @access 		public
 */
class XshopFormSelectProductsStock extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XshopFormSelectProductsStock($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach(array('_SHOP_MI_PRODUCTS_INSTOCK','_SHOP_MI_PRODUCTS_OUTSTOCK','_SHOP_MI_PRODUCTS_NOREORDER','_SHOP_MI_PRODUCTS_QUITSTOCK','_SHOP_MI_PRODUCTS_SUPLUSSTOCK') as $item)
