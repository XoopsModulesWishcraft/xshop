...
insert  into `shop_currency` (`currency_id`,`languages`,`item_id`,`symbol_left`,`symbol_right`,`decimal_places`,`thousand_seperator`,`iso_code`,`default`,`rate`,`exchange_currency_id`,`exchange_comparison_rate`,`exchange_set`,`md5`,`created`,`updated`) values (1,'a:1:{s:7:"english";}', 1,'$',NULL,2,',','AUD',1,'1.0000000',0,'1.0000000',0,NULL,0,0);
