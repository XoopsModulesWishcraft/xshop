 ...
 * @access 		public
 */
class XShopFormSelectOrdersMode extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XShopFormSelectOrdersMode($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach(array('_SHOP_MI_ORDER_OPENORDER','_SHOP_MI_ORDER_CLOSEDORDER','_SHOP_MI_ORDER_CHECKEDOUT','_SHOP_MI_ORDER_GONETOINVOICING','_SHOP_MI_ORDER_OTHER') as $item)
