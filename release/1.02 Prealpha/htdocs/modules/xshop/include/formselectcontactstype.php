 ...
 * @access 		public
 */
class XShopFormSelectContactsType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XShopFormSelectContactsType($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach(array('_SHOP_MI_CONTACTS_EMAIL','_SHOP_MI_CONTACTS_PHONE','_SHOP_MI_CONTACTS_MOBILE','_SHOP_MI_CONTACTS_FAX','_SHOP_MI_CONTACTS_PAGER','_SHOP_MI_CONTACTS_OTHER') as $item)
