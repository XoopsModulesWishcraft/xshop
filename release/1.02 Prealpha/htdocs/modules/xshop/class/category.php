...
class xshopCategory extends XoopsObject 
{
	...
	function toArray() {
    	...
    	$ret['picture'] = get_picture($this->getVar('logo_picture_id'));
    ...
    function getForm($querystring, $captions = true, $render = true, $index = '', $cursor = 'form', $frmobj = array()) {
    	...
    	if ($render == true||$captions==true) {
	    	...
	    	$frmobj[$cursor]['logo_picture_id'] = new XShopFormFile(_SHOP_FRM_CATEGORY_NEW_LOGO, $id.'[logo_picture_id]', $GLOBALS['xoopsModuleConfig']['max_upload_size']);
