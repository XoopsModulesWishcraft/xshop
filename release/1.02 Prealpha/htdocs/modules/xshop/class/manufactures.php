...
class xshopManufactures extends XoopsObject 
{
    ...
    function getForm($querystring, $captions = true, $render = true, $index = '', $cursor = 'form', $frmobj = array()) {
    	...
    	if ($render = true||$captions==true) {
	    	...
	    	$frmobj[$cursor]['logo_manu_id'] = new XShopFormFile(_SHOP_FRM_MANUFACTURES_UPLOAD_LOGO, $id.'[logo_manu_id]', $GLOBALS['xoopsModuleConfig']['max_file_size']);
	    	...
	    	$frmobj[$cursor]['logo_manu_id'] = new XShopFormFile('', $id.'[logo_manu_id]', $GLOBALS['xoopsModuleConfig']['max_file_size']);
