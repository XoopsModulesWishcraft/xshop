 ...
 * @access 		public
 */
class XoopsFormSelectMeasurement extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectMeasurement($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach(array('_SHOP_MI_WEIGHT_KILOS', '_SHOP_MI_WEIGHT_POUNDS') as $item)
