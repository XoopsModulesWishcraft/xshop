 ...
 * @access 		public
 */
class XoopsFormSelectAddressRemittion extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectAddressRemittion($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach(array('_SHOP_MI_ADDRESS_RETURNEDGOODS','_SHOP_MI_ADDRESS_FRAUD','_SHOP_MI_ADDRESS_STOLENINMAIL','_SHOP_MI_ADDRESS_EXPRESSDELIEVERY','_SHOP_MI_ADDRESS_NONE') as $item)
