 ...
 * @access 		public
 */
class XoopsFormSelectShopType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectShopType($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach(array('_SHOP_MI_SHOPS_PHYSICALSTORE','_SHOP_MI_SHOPS_DELIVERYRUN','_SHOP_MI_SHOPS_SERVICECENTER','_SHOP_MI_SHOPS_SERVICEWAREHOUSE','_SHOP_MI_SHOPS_SERVICE','_SHOP_MI_SHOPS_OTHER') as $item)
