 ...
 * @access 		public
 */
class XoopsFormSelectProductsType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectProductsType($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
