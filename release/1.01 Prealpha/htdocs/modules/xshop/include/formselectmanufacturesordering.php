 ...
 * @access 		public
 */
class XoopsFormSelectManufacturesOrdering extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectManufacturesOrdering($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach(array('_SHOP_MI_MANU_PLACESTOCKORDER','_SHOP_MI_MANU_DONTPLACESTOCKORDER','_SHOP_MI_MANU_MANUALORDER','_SHOP_MI_MANU_RAISETOPURCHASEOFFICER','_SHOP_MI_MANU_APIORDERING') as $item)
