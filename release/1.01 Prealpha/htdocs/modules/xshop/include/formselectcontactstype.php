 ...
 * @access 		public
 */
class XoopsFormSelectContactsType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectContactsType($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
