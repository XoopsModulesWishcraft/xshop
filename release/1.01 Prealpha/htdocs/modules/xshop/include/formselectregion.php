 ...
 * @access 		public
 */
class XoopsFormSelectRegion extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectRegion($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach($region_handler->getObjects($criteria, true) as $region_id => $item)
			$this->addOption($region_id, $item->getVar('name'));
    }
