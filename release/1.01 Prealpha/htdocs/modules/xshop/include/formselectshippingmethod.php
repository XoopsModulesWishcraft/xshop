 ...
 * @access 		public
 */
class XoopsFormSelectShippingMethod extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectShippingMethod($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
