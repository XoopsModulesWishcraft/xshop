...
class XshopVisibility extends XoopsObject
{
    ...
    function XshopVisibility()
    {
        $this->__construct();
    }
}

class XshopVisibilityHandler extends XoopsPersistableObjectHandler
{
    function __construct($db)
    {
        parent::__construct($db, 'xshop_visibility', 'XshopVisibility', 'field_id');
    }
