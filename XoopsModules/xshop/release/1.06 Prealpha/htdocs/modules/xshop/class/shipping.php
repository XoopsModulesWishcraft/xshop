...
class xshopShipping extends XoopsObject 
{
    ...
    function __construct()
    {
        ...
        $this->initVar('md5', XOBJ_DTYPE_TXTBOX, false, false, 32);
    ...
    function getForm($querystring, $captions = true, $render = true, $index = '', $cursor = 'form', $frmobj = array(), $const = '_SHOP_MI_SHIPPING') {
    	...
    	if ($render==true||$captions==true) {
	    	...
	    	$frmobj[$cursor]['method'] = new XShopFormSelectShippingMethod(_SHOP_FRM_SHIPPING_METHOD, $id.'[method]', $this->getVar('method'));
	    	...
	    	$frmobj[$cursor]['method'] = new XShopFormSelectShippingMethod('', $id.'[method]', $this->getVar('method'));
