 ...
 * @access 		public
 */
class XShopFormSelectTimezone extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XShopFormSelectTimezone($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		for($hour=-12;$hour<=12;$hour++) {
			$this->addOption($hour, ($hour>0?'+':'').$hour.'.00');	
		}
