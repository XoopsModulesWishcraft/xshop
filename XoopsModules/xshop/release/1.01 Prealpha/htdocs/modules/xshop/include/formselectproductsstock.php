 ...
 * @access 		public
 */
class XoopFormSelectProductsStock extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopFormSelectProductsStock($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
