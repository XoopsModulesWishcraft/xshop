 ...
 * @access 		public
 */
class XoopsFormSelectOrdersRemittion extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectOrdersRemittion($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
