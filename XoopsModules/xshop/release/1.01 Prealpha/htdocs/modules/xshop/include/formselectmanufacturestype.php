 ...
 * @access 		public
 */
class XoopsFormSelectManufacturesType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectManufacturesType($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
