 ...
 * @access 		public
 */
class XoopsFormSelectCountry extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectCountry($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach($country_handler->getObjects($criteria, true) as $country_id => $item)
			$this->addOption($country_id, $item->getVar('name'). ' ('.$item->getVar('alpha3').')');
    }
