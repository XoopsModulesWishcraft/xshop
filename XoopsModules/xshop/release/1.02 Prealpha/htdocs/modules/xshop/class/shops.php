...
class xshopShops extends XoopsObject 
{
	...
	function getForm($querystring, $captions = true, $render = true, $index = '', $cursor = 'form', $frmobj = array()) {
    	...
    	if ($render==true||$captions==true) {
	    	...
	    	$frmobj[$cursor]['admin_uids'] = new XShopFormSelectGroupedUser(_SHOP_FRM_SHOPS_ADMINS, 'admin_uids', $this->getVar('admin_uids'), 6, true, $GLOBALS['xoopsModuleConfig']['administrators']);
	    	$frmobj[$cursor]['admin_uids']->setDescription(_SHOP_FRM_SHOPS_ADMINS_DESC);
	    	$frmobj[$cursor]['broker_uids'] = new XShopFormSelectGroupedUser(_SHOP_FRM_SHOPS_BROKERS, 'broker_uids', $this->getVar('broker_uids'), 6, true, $GLOBALS['xoopsModuleConfig']['brokers']);
	    	$frmobj[$cursor]['broker_uids']->setDescription(_SHOP_FRM_SHOPS_BROKERS_DESC);
	    	$frmobj[$cursor]['sales_uids'] = new XShopFormSelectGroupedUser(_SHOP_FRM_SHOPS_SALES, 'sales_uids', $this->getVar('sales_uids'), 6, true, $GLOBALS['xoopsModuleConfig']['sales']);
	    	$frmobj[$cursor]['sales_uids']->setDescription(_SHOP_FRM_SHOPS_SALES_DESC);
	    	$frmobj[$cursor]['express_id'] = new XShopFormSelectShipping(_SHOP_FRM_SHOPS_EXPRESS, 'express_id', $this->getVar('express_id'), 1, false, true);
	    	...
	    	$frmobj[$cursor]['opening'] = new XShopFormSelectTime(_SHOP_FRM_SHOPSS_OPENING,  $id.'[opening]', $this->getVar('opening'));
	    	$frmobj[$cursor]['opening']->setDescription(_SHOP_FRM_SHOPSS_OPENING_DESC);
	    	$frmobj[$cursor]['closing'] = new XShopFormSelectTime(_SHOP_FRM_SHOPSS_CLOSING,  $id.'[closing]', $this->getVar('closing'));
	    	...
	    	$frmobj[$cursor]['logo_picture_id'] = new XShopFormFile(_SHOP_FRM_SHOPS_UPLOAD_LOGO, $id.'[logo_picture_id]', $GLOBALS['xoopsModuleConfig']['max_file_size']);
	    	...
	    	$frmobj[$cursor]['admin_uids'] = new XShopFormSelectGroupedUser('', 'admin_uids', $this->getVar('admin_uids'), 6, true, $GLOBALS['xoopsModuleConfig']['administrators']);
	    	$frmobj[$cursor]['broker_uids'] = new XShopFormSelectGroupedUser('', 'broker_uids', $this->getVar('broker_uids'), 6, true, $GLOBALS['xoopsModuleConfig']['brokers']);
	    	$frmobj[$cursor]['sales_uids'] = new XShopFormSelectGroupedUser('', 'sales_uids', $this->getVar('sales_uids'), 6, true, $GLOBALS['xoopsModuleConfig']['sales']);
	    	$frmobj[$cursor]['express_id'] = new XShopFormSelectShipping('', 'express_id', $this->getVar('express_id'), 1, false, true);
	    	...
	    	$frmobj[$cursor]['logo_picture_id'] = new XShopFormFile('', $id.'[logo_picture_id]', $GLOBALS['xoopsModuleConfig']['max_file_size']);
