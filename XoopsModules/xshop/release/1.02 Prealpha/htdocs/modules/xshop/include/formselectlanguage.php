 ...
 * @access 		public
 */
class XShopFormSelectLanguage extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XShopFormSelectLanguage($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        $language_handler = xoops_getmodulehandler('xlanguage_ext', 'xshop');
