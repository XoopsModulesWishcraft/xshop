 ...
 * @access 		public
 */
class XShopFormSelectManufactures extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XShopFormSelectManufactures($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
