 ...
 * @access 		public
 */
class XShopFormSelectCategory extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XShopFormSelectCategory($caption, $name, $value = null, $size = 1, $multiple = false, $ownid=0)
    {
	...
	function TreeMenu($langs_array, $categories, $level, $ownid) {
		...
		foreach($categories as $catid => $category) {
			if ($catid!=$ownid) {
    			...
    			$digest = $items_digest_handler->getItem($category->getVar('item_id'));
				$langs_array[$catid] = str_repeat('--', $level).$digest->getVar('menu_title');
