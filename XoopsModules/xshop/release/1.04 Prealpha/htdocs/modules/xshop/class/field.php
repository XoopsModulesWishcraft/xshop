...
class xshopField extends XoopsObject
{
    function __construct()
    {
        ...
        $this->initVar('manu_ids', XOBJ_DTYPE_ARRAY, array(0=>'0'), true);
        $this->initVar('shop_ids', XOBJ_DTYPE_ARRAY, array(0=>'0'), true);
        $this->initVar('cat_ids', XOBJ_DTYPE_ARRAY, array(0=>'0'), true);
