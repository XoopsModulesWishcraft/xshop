 ...
 * @access 		public
 */
class XShopFormSelectManufacturesType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XShopFormSelectManufacturesType($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach(array('_SHOP_MI_MANU_LOCAL','_SHOP_MI_MANU_INTERSTATE','_SHOP_MI_MANU_OVERSEAS','_SHOP_MI_MANU_INTERNAL','_SHOP_MI_MANU_UNKNOWN') as $item)
