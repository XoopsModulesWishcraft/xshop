 ...
 * @access 		public
 */
class XShopFormSelectTime extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XShopFormSelectTime($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		for($hour=0;$hour<24;$hour++) {
			for($minute=0;$minute<60;$minute=$minute+10) {
				$this->addOption(((60*60)*$hour)+($minute*60), (strlen($hour)==1?'0':'').$hour.':'.(strlen($minute)==1?'0':'').$minute);	
			}
		}
