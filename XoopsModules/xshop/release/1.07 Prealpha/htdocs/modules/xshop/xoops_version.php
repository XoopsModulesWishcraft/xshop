...
$modversion['config'][$i]['title'] = "_SHOP_MI_SUPPORTTAGS";
$modversion['config'][$i]['description'] = "_SHOP_MI_SUPPORTTAGS_DESC";
$modversion['config'][$i]['formtype'] = 'yesno';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 0;
...
$i=0;
$i++;
$modversion["blocks"][$i]	=	array(	"file"           => "xshop_block_tag.php",
    									"name"           => "XShop Tag Cloud",
    									"description"    => "Show tag cloud",
    									"show_func"      => "xshop_tag_block_cloud_show",
    									"edit_func"      => "xshop_tag_block_cloud_edit",
    									"options"        => "100|0|150|80",
    									"template"       => "xshop_tag_block_cloud.html"
    							);
$i++;  
$modversion["blocks"][$i]	= 	array(	"file"           => "xshop_block_tag.php",
								    	"name"           => "XShop Top Tags",
								    	"description"    => "Show top tags",
								    	"show_func"      => "xshop_tag_block_top_show",
								    	"edit_func"      => "xshop_tag_block_top_edit",
								    	"options"        => "50|30|c",
								    	"template"       => "xshop_tag_block_top.html"
    							);
// Templates
$i = 0;
$i++;
...
$i++;
$modversion['templates'][$i]['file'] = 'xshop_orders_finalise.html';
$modversion['templates'][$i]['description'] = _SHOP_MI_TEMPLATE_ORDERS_FINALISE;
$i++;
$modversion['templates'][$i]['file'] = 'xshop_orders_invoiced.html';
$modversion['templates'][$i]['description'] = _SHOP_MI_TEMPLATE_ORDERS_INVOICED;
$i++;
$modversion['templates'][$i]['file'] = 'xshop_orders_closed.html';
$modversion['templates'][$i]['description'] = _SHOP_MI_TEMPLATE_ORDERS_CLOSED;
$i++;
$modversion['templates'][$i]['file'] = 'xshop_orders_checkedout.html';
$modversion['templates'][$i]['description'] = _SHOP_MI_TEMPLATE_ORDERS_CHECKEDOUT;
$i++;
$modversion['templates'][$i]['file'] = 'xshop_orders_details.html';
$modversion['templates'][$i]['description'] = _SHOP_MI_TEMPLATE_ORDERS_DETAILS;
$i++;
$modversion['templates'][$i]['file'] = 'xshop_downloads.html';
$modversion['templates'][$i]['description'] = _SHOP_MI_TEMPLATE_DOWNLOADS;
$i++;
...
if ($orders_handler->getCount($criteria)>0) {
	...
	$modversion['sub'][$i]['url'] = "index.php?op=orders&fct=checkout";
}
$criteria = new CriteriaCompo($criteria_a, 'AND');
