 ...
 */
	...
	case 'permissions':
		...
		echo '<option value="'.XOOPS_URL.'/modules/xshop/admin/index.php?op=permissions&fct=category"';
		if ($fct=='category') echo ' selected="selected">'._SHOP_AM_PERM_CATEGORY.'</option>'; else echo '>'._SHOP_AM_PERM_CATEGORY.'</option>';

		echo '<option value="'.XOOPS_URL.'/modules/xshop/admin/index.php?op=permissions&fct=shops"';
