 ...
 * @access 		public
 */
class XShopFormSelectAddressRemittion extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XShopFormSelectAddressRemittion($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
